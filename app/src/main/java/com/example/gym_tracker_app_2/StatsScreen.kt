...
class StatsScreen: ComponentActivity() {
    ...
    inner class PeriodSelectorListener : OnItemSelectedListener {
        ...
        override fun onItemSelected(parent: AdapterView<*>, view: View, position: Int, id: Long) {
            ...
            val exerciseData = DatabaseInterface.getInstance(applicationContext).getExerciseStats(exerciseType, currentDate.format(DateTimeFormatter.ofPattern("yyyy.MM.dd")))
            ...
            workouts.clear()
            workouts.addAll(DatabaseInterface.getInstance(applicationContext).getExerciseWorkouts(exerciseType,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        exerciseTitle.setText(DatabaseInterface.getInstance(applicationContext).getExerciseTypeName(exerciseType))
        ...
        exerciseTitle.setOnFocusChangeListener { _, hasFocus ->
            if(!hasFocus) {
                ...
                if(!DatabaseInterface.getInstance(applicationContext).setExerciseName(exerciseType, exerciseTitle.text.toString())) {
